...
document.writeln('<iframe id="embed-form-<?php echo $form_data['hash']; ?>" width="100%" src="<?php echo href_to_abs('forms', 'embed', $form_data['hash']); ?>" height="250" border="0" framespacing="0" frameborder="0"></iframe>');