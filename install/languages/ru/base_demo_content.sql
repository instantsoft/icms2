...
(6, 1, 0, 'Фото', 'albums', 4, '---\ntarget: _self\nclass:', '---\n- 0\n', NULL),
(7, 1, 0, 'Сайты', 'http://www.dmoz.org', 10, NULL, NULL, NULL),
...
(159, 'content', 'board.all', 'LANG_WP_CONTENT_ALL_PAGES', 'Объявления', NULL, 'board\nboard-*\nboard/*', NULL),
(160, 'content', 'board.list', 'LANG_WP_CONTENT_LIST', 'Объявления', NULL, 'board\nboard-*\nboard/*', 'board/*.html\nboard/add\nboard/edit/*'),
(161, 'content', 'board.item', 'LANG_WP_CONTENT_ITEM', 'Объявления', NULL, 'board/*.html', NULL),
(162, 'content', 'board.edit', 'LANG_WP_CONTENT_ITEM_EDIT', 'Объявления', NULL, 'board/add\nboard/edit/*', NULL),
(163, 'content', 'news.all', 'LANG_WP_CONTENT_ALL_PAGES', 'Новости', NULL, 'news\nnews-*\nnews/*', NULL),
(164, 'content', 'news.list', 'LANG_WP_CONTENT_LIST', 'Новости', NULL, 'news\nnews-*\nnews/*', 'news/*.html\nnews/add\nnews/edit/*'),
(165, 'content', 'news.item', 'LANG_WP_CONTENT_ITEM', 'Новости', NULL, 'news/*.html', NULL),
(166, 'content', 'news.edit', 'LANG_WP_CONTENT_ITEM_EDIT', 'Новости', NULL, 'news/add\nnews/edit/*', NULL);