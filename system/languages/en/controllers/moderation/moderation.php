...
define('LANG_MODERATION_LOG_RESTORE', 'Keep a recoveries log');
define('LANG_MODERATION_CLEAR_LOG_AFTER_DELETE', 'Clear all item logs after completely delete');
define('LANG_MODERATION_TRASH_LEFT_TIME_HINT', 'After this time, the item will be completely deleted. 0 - do not remove, not set - by default');
define('LANG_MODERATION_ACTION_0', 'Deleting to trash');
define('LANG_MODERATION_ACTION_1', 'Complete removal');
define('LANG_MODERATION_ACTION_2', 'Restore from trash');
...
define('LANG_MODERATION_DELETE_CUSTOM', 'Logs for the "%s" deleted successfully');
