...
define('LANG_REDIRECT_HINT3', 'Если Вы не хотите рисковать безопасностью компьютера, закройте эту вкладку, иначе вы будете перемещены через');
...
define('LANG_REDIRECT_SUSPICIOUS_LINK_1', 'Ссылка, по которой Вы попытались перейти, может вести на сайт, который был создан с целью обмана пользователей и получения за счет этого прибыли.');
...
define('LANG_REDIRECT_IS_CHECK_LINK_HINT', 'Ссылки проверяются посредством <a href="https://dev.vk.com/ru/method/utils.checkLink" target="_blank" rel="noopener noreferrer">открытого метода Вконтакте</a>');
define('LANG_REDIRECT_VK_ACCESS_TOKEN', 'Сервисный ключ доступа');
define('LANG_REDIRECT_VK_ACCESS_TOKEN_HINT', 'Получить ключ можно в <a href="https://dev.vk.com/ru/api/access-token/getting-started" target="_blank" rel="noopener noreferrer">настройках приложения Вконтакте</a>');
