...
define('LANG_REDIRECT_IS_CHECK_LINK_HINT', 'Links are checked through the <a href="https://dev.vk.ru/en/method/utils.checkLink" target="_blank" rel="noopener noreferrer">Vkontakte Open Method</a>');
define('LANG_REDIRECT_VK_ACCESS_TOKEN', 'Service access key');
define('LANG_REDIRECT_VK_ACCESS_TOKEN_HINT', 'You can get the key at <a href="https://dev.vk.ru/en/api/access-token/getting-started" target="_blank" rel="noopener noreferrer">VK application settings</a>');
