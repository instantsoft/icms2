...
/**
 * Группирует массив по указанному ключу. Дополнительно указанные ключи будут
 * использоваться для группировки следующего набора под-массивов
 *
 * @author Jake Zatecky
 * @link https://github.com/jakezatecky/array_group_by
 *
 * @param array $arr Входной массив для группировки
 * @param mixed $key Ключ на основании которого группируется массив.
 * @return array
 */
function array_group_by($arr, $key) {
    ...
    // Создается рекурсивная группировка, если передано больше 2-х параметров
    // Каждый группируемый массив группируется в соответствии со следующим значением указанного ключа 
    if (func_num_args() > 2) {
        $args = func_get_args();
