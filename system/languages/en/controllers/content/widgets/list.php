...
define('LANG_WD_CONTENT_WIDGET_TYPE2', 'Display related list');
define('LANG_WD_CONTENT_WIDGET_TYPE3', 'Display a random list');
define('LANG_WD_CONTENT_RELATED_TYPE', 'Select related by');
define('LANG_WD_CONTENT_RELATED_TYPE1', 'Title');
define('LANG_WD_CONTENT_RELATED_TYPE2', 'Tags if available, otherwise by current category');
define('LANG_WD_CONTENT_RELATED_TYPE3', 'Category');
define('LANG_WD_CONTENT_DEPRECATED', 'Deprecated options');
define('LANG_WD_CONTENT_AUTO_USER', 'Show only author items');
define('LANG_WD_CONTENT_AUTO_USER_HINT', 'If the widget displays on item pages or user profiles.');
