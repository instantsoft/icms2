<?php
// можно отправить форму повторно не перезагружая страницу, при этом поле с текстом об успешной отправке формы не появляется. Думаю нужно поправить или сделать настройку в опциях формы "Скрывать форму после отправки?" - Да/Нет
