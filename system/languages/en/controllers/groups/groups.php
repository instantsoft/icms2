<?php
    ...
    define('LANG_GROUPS_GROUP_WALL_POLICY', 'Who can post on the group wall');
    ...
    define('LANG_GROUPS_GROUP_PRIVATE_SOFT','Anyone invited by members');
    define('LANG_GROUPS_GROUP_PRIVATE_HARD','Anyone invited by admin');
