...
(176, 'admin_col_scheme_options', 'bootstrap', 176, 1),
(178, 'admin_row_scheme_options', 'bootstrap', 178, 1),
(186, 'ctype_field_users_after_update', 'bootstrap', 186, 1),
(187, 'widget_menu_form', 'bootstrap', 187, 1),
(190, 'db_nested_tables', 'content', 190, 1),
(191, 'widget_content_list_form', 'content', 191, 1),
(214, 'render_widget_menu_menu', 'bootstrap', 214, 1),
...
CREATE TABLE `{#}menu_items` (
  ...
  `hint` varchar(64) DEFAULT NULL COMMENT 'Краткое описание пункта меню',
...
CREATE TABLE `{#}widgets_pages` (
  ...
  `title` varchar(64) DEFAULT NULL COMMENT 'Название страницы',
  ...
  `body_css` varchar(100) DEFAULT NULL COMMENT 'CSS класс для тега body',
  `layout` varchar(32) DEFAULT NULL COMMENT 'Название лайоута для страницы',
  PRIMARY KEY (`id`),
  KEY `controller` (`controller`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
