<?php
    ...
    define('LANG_GROUPS_INVITE_PENDING',    'Invitation was sent earlier and pending consideration');
    define('LANG_GROUPS_NOTIFY_INVITE',     'Notify on group invitations');
    ...
    define('LANG_GROUPS_GROUP_JOIN_POLICY', 'Group joining');
    define('LANG_GROUPS_GROUP_EDIT_POLICY', 'Editing group description');
    define('LANG_GROUPS_GROUP_EDIT_OWNER',  'Only owner');
    define('LANG_GROUPS_GROUP_EDIT_STAFF',  'Owner and administrators');
    define('LANG_GROUPS_GROUP_WALL_POLICY', 'Who can write on group wall');
