<?php
    ...
    define('LANG_CP_DASHBOARD_SI_TMP',          'Temporary files directory');
    ...
    define('LANG_CP_MENU_COPY',                 'Copy items to menu');
    ...
    define('LANG_CP_MENU_ITEM_ACTION_URL_HINT', 'Internal links should come without a leading slash<br/>External links should start with http(s)://<br/>You can enter <a href="https://docs.instantcms.ru/en/manual/menu/special" target="_blank">Special Links</a>');
    ...
    define('LANG_CP_SETTINGS_ALLOW_IPS_ERROR',   'You cannot deny yourself access. Your ip address: %s.');
