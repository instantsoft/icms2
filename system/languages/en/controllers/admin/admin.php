<?php
    ...
    define('LANG_CP_TAB_IS_ACTIVE',             'Tab enabled');
    ...
    define('LANG_CP_MENU_IS_FIXED',             'You cannot delete this menu');
    ...
    define('LANG_CP_USER_GROUP_DELETE_CONFIRM', 'Delete the selected group?\nUsers will not be deleted');
    define('LANG_CP_USER_GROUP_CREATED',        'Group &laquo;%s&raquo; has been created');
    define('LANG_CP_USER_GROUP_IS_PUBLIC',      'Allow to join this group after registration');
    ...
    define('LANG_CP_SETTINGS_FP_SHOW',          'Show on homepage');
    ...
    define('LANG_CP_INSTALL_NOT_WRITABLE_FIX',  'Set permissions to 777 for the folder and refresh the page');
    ...
    define('LANG_CP_INSTALL_NOT_ZIP_WA',        'Change the file extension to <b>.zip</b>, unpack and upload its contents to the <b>%s</b> folder');
	...
	define('LANG_CP_FTP_PATH_HINT',             '<a href="http://docs.instantcms.ru/en/manual/addons/ftppath" target="_blank">How to specify a correct path?</a>');
