...
define('LANG_REDIRECT_IS_CHECK_LINK_HINT', 'Ссылки проверяются посредством <a href="https://dev.vk.ru/ru/method/utils.checkLink" target="_blank" rel="noopener noreferrer">открытого метода Вконтакте</a>');
define('LANG_REDIRECT_VK_ACCESS_TOKEN', 'Сервисный ключ доступа');
define('LANG_REDIRECT_VK_ACCESS_TOKEN_HINT', 'Получить ключ можно в <a href="https://dev.vk.ru/ru/api/access-token/getting-started" target="_blank" rel="noopener noreferrer">настройках приложения Вконтакте</a>');
